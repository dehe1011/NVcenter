...
def get_spin_bath_density(
    spin_type, density, shape, rmin, rmax, pos_seed=123, init_state_seed=123, lamor_seed=123
):
...
def calc_spin_baths_density(spin_type, density, shape, rmin, rmax, num_baths, num_init_states):
...
def calc_spin_baths_abundancy(spin_type, abundancy, rmin, rmax, num_baths, num_init_states):
    """ Creates bath configurations. """
